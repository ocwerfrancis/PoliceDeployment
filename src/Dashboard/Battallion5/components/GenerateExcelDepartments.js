...
function GenerateExcelSections(props) {
  ...
  const handle_submit_data = (e) => {
    const url_general = 'export_battalion_five_department';
    const url_status = 'export_battalion_five_department_status';
    const url_leave = 'export_battalion_five_department_leave';
