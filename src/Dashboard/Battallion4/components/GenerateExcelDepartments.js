...
function GenerateExcelSections(props) {
  ...
  const handle_submit_data = (e) => {
    const url_general = 'export_battalion_four_department';
    const url_status = 'export_battalion_four_department_status';
    const url_leave = 'export_battalion_four_department_leave';
